...
SETUP: 
Place all of the Blinks together, with one at the front, connected to either one or three Blinks, and the rest behind. A blink that can start will turn white, with a green indicator showing which direction the minefield will be. This Blink will be the first space on the map, while those behind should be placed so they will be off the minefield. Press that Blink to create and begin transfer of the map to all others. Wait for this process to complete, and then you're good to go! 
