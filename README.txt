...
SETUP: 
Place all of the Blinks together, with one at the front and the rest behind. A blink that can start will flicker white. This Blink will be the first space on the map, while those behind should be placed so they will be off the map. Double press that Blink to create and begin transfer of the map to all others. Wait for this process to complete, and then you're good to go! 
